...
class NTreeNode {
    ...
    public static NTreeNode buildBinaryTree() {
        ...
        list3.add(new NTreeNode(5, new ArrayList<>()));
        list3.add(new NTreeNode(6, new ArrayList<>()));
        NTreeNode nTreeNode3 = new NTreeNode(3, list3);

        List<NTreeNode> list1 = new ArrayList<>();
        list1.add(nTreeNode3);
        list1.add(new NTreeNode(2, new ArrayList<>()));
        list1.add(new NTreeNode(4, new ArrayList<>()));
